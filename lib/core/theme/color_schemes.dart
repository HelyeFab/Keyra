...
class AppColors {
  ...
  static const Color darkSurface = Color(0xFF1A2642);    // Slightly lighter deep blue
  static const Color darkSurfaceVariant = Color(0xFF243353); // Even lighter deep blue
  static const Color darkSurfaceContainer = Color(0xFF1F2B47); // Mid-tone deep blue
  static const Color darkOnPrimary = Color(0xFF000000);
  static const Color darkOnSecondary = Color(0xFF000000);
  static const Color darkOnTertiary = Color(0xFFFFFFFF);
  static const Color darkOnBackground = Color(0xFFFFFFFF);
  static const Color darkOnSurface = Color(0xFFE1E3E6);  // Lighter gray for better readability
